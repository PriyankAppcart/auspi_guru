...
class ghatika_calc
{
  ...
  var pal_act=0.00;
  var vipal=0.00;
  var vipal_final_value=0.00;
  var pal_final_value=0.00;
  var ghatika_final_value=0.00;
   ...
   // var today= DateTime(DateTime.now().year,DateTime.now().month,DateTime.now().day,int.parse("06"),int.parse("30"),int.parse("00"));
    ...
    if(CurrentTime >= SetTodaySunriseTime ) {
      ...
      if(CurrentTime >= SetTodaySunsetTime)
      {
        ...
        var Day_vipal_total=Daytime*2.5;
        ...
        var NighttimeNow = CurrentDate
            .difference(SetTodaySunsetDate)
            .inSeconds;
        vipal_final_value=(((Daytime+NighttimeNow)*2.5)%60);
        pal_final_value=((((Daytime+NighttimeNow)*2.5)%3600)/60);
        ghatika_final_value=(((Daytime+NighttimeNow)*2.5)/3600);
        print("ghatikaCalc_vipal_sunrise$vipal_final_value");
        print("ghatikaCalc_pal_sunrise$pal_final_value");
        print("ghatikaCalc_ghatika_sunrise$ghatika_final_value");
      ...
      else
        {
          ...
          var Daytime = SetTodaySunsetDate
              .difference(SetTodaySunriseDate)
              .inSeconds;
          var Daytimemili = SetTodaySunsetDate
              .difference(SetTodaySunriseDate)
              .inMilliseconds;
          var NightTime = SetNextSunriseDate
              .difference(SetTodaySunsetDate)
         ...
         // var Day_vipal_total=Daytime*2.5;
          var Day_vipal_total=Daytime*2.5;
          var Day_vipal_totalmili=Daytimemili/2500;
          print("ghatikaCalc_Day_vipal_total$NightTime");
          print("ghatikaCalc_Day_vipal_total$Daytime");
          print("ghatikaCalc_Day_vipal_total$Daytimemili");
          print("Night_vipal_remain${216000.0-Day_vipal_total}");
          // print("Night_vipal_remain${NightTime*2.5}");
          var DaytimeNow = CurrentDate
              .difference(SetTodaySunriseDate)
              .inSeconds;
          //vipal_final_value=((DaytimeNow%530));
         // pal_final_value=(((DaytimeNow/530)%3600)/60);
         //  ghatika_final_value=((DaytimeNow/530)/3600);
           vipal_final_value=((DaytimeNow*2.5)%60);
           pal_final_value=(((DaytimeNow*2.5)%3600)/60);
           ghatika_final_value=((DaytimeNow*2.5)/3600);
           print("ghatikaCalc_vipal_sunrise$vipal_final_value");
          print("ghatikaCalc_pal_sunrise$pal_final_value");
          print("ghatikaCalc_ghatika_sunrise$ghatika_final_value");
          var DaytimeEqual = Daytime / 30;//one ghatika
    ...
    {
      var PrevDaytime = SetPrevSunsetDate
          .difference(SetPrevSunriseDate)
          .inSeconds;

      var Day_vipal_total=PrevDaytime*2.5;
      ...
      var NighttimeNow = CurrentDate
          .difference(SetPrevSunsetDate)
          .inSeconds;
      vipal_final_value=(((PrevDaytime+NighttimeNow)*2.5)%60);
      pal_final_value=((((PrevDaytime+NighttimeNow)*2.5)%3600)/60);
      ghatika_final_value=(((PrevDaytime+NighttimeNow)*2.5)/3600);
      print("ghatikaCalc_vipal_sunrise$vipal_final_value");
      print("ghatikaCalc_pal_sunrise$pal_final_value");
      print("ghatikaCalc_ghatika_sunrise$ghatika_final_value");
      var NighttimeEqual = NightTime / 30;
...
//     }
    ...
    List<String> return_value=[prahar,ghatika_final_value.toString(),pal_final_value.toString(),vipal_final_value.toString(),
      ghatika_act.toString(),pal_act.toString(),vipal.toString()];
